...
fun SearchBar(
    ...
    OutlinedTextField(
        ...
        colors = OutlinedTextFieldDefaults.colors(
            unfocusedBorderColor = colorResource(R.color.border_strong),
            focusedBorderColor = colorResource(R.color.border_strong),
            unfocusedContainerColor = colorResource(R.color.bg_card),
            focusedContainerColor = colorResource(R.color.bg_card)
        ),
        singleLine = true,
        textStyle = TextStyle(
            fontFamily = FontFamily(Font(R.font.outfit_font)),
...
private fun UserProfilePreview() {
    ...
    UserProfile(contact = user, modifier = Modifier.background(colorResource(R.color.bg_page)))
}